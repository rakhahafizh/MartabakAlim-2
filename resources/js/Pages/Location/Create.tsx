...
export default function LocationCreate() {
  ...
  return (
    <AppLayout title="Tambah Lokasi Baru - Martabak Alim">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Tambah Lokasi Baru</h1>
          <p className="text-gray-600 mb-8">Isi form di bawah untuk menambahkan lokasi cabang baru.</p>

...
export default function ProductEdit({ product }: ProductEditProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.post(`/products/${product.id}`, formDataToSend, {
      onError: (errors) => {
  ...
  return (
    <AppLayout title={`Edit ${product.name} - Martabak Alim`}>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Edit Produk: {product.name}</h1>
          <p className="text-gray-600 mb-8">Update informasi produk menu.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">Kosongkan jika tidak ingin mengubah gambar</p>
              {imagePreview && (
                <div className="mt-4">
